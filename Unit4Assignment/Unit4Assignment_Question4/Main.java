...
public class Main{ // declare main class
	...
	public static void main (String [] args){ // declare main method
        ...
        while (true) { // run the loop indefinately until break statement
            double orderTotal = 0; // declare an init a new double
            ...
            orderTotal += numHamburgers * hamburger.getPrice(); // add the item price x quantity to the order total 
            ...
            orderTotal += numSalads * salad.getPrice(); // add the item price x quantity to the order total
            ...
            orderTotal += numNuggets * nuggets.getPrice(); // add the item price x quantity to the order total
            ...
            orderTotal += numSodas * soda.getPrice(); // add the item price x quantity to the order total
            System.out.println("Each soda has " + soda.toString() + '\n'); // print nutrition info for a soda


            orderTotal *= HST_PRICE_FACTOR; // calcuate the order total with tax
